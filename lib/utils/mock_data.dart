...
const String _avocadoToastImg =
    "https://images.unsplash.com/photo-1525351484163-7529414344d8?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _pastaImg =
    "https://images.unsplash.com/photo-1612874742237-6526221588e3?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _pancakesImg =
    "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _tacosImg =
    "https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _curryImg =
    "https://images.unsplash.com/photo-1565557623262-b51c2513a641?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _brownieImg =
    "https://images.unsplash.com/photo-1606313564200-e75d5e30476c?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _ramenImg =
    "https://images.unsplash.com/photo-1557872943-16a5ac26437e?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _macCheeseImg =
    "https://images.unsplash.com/photo-1543339494-b4cd4f7ba686?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";

// --- New 20 Images ---
const String _sandwichImg =
    "https://images.unsplash.com/photo-1528735602780-2552fd46c7af?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _roastChickenImg =
    "https://images.unsplash.com/photo-1598514982205-f36b96d1e8d4?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _risottoImg =
    "https://thumb.wikimedia.org/wikipedia/commons/thumb/a/a5/Risotto_with_speck_and_goat_cheese_%286101067436%29.jpg/960px-Risotto_with_speck_and_goat_cheese_%286101067436%29.jpg";
const String _paellaImg =
    "https://images.unsplash.com/photo-1534080564583-6be75777b70a?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _bruschettaImg =
    "https://images.unsplash.com/photo-1572695157366-5e585ab2b69f?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _muffinImg =
    "https://thumb.wikimedia.org/wikipedia/commons/thumb/4/4c/02116jfMuffins_in_Philippinesfvf_02.jpg/960px-02116jfMuffins_in_Philippinesfvf_02.jpg";
const String _croissantImg =
    "https://thumb.wikimedia.org/wikipedia/commons/thumb/2/2a/Croissant-Petr_Kratochvil.jpg/960px-Croissant-Petr_Kratochvil.jpg";
const String _donutImg =
    "https://images.unsplash.com/photo-1551024601-bec78aea704b?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _iceCreamImg =
    "https://images.unsplash.com/photo-1497034825429-c343d7c6a68f?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _ribsImg =
    "https://thumb.wikimedia.org/wikipedia/commons/thumb/2/20/Balinese_Roasted_Pork_Ribs_-_Iga_Babi_Panggang_Bali.JPG/960px-Balinese_Roasted_Pork_Ribs_-_Iga_Babi_Panggang_Bali.JPG";
const String _biryaniImg =
    "https://images.unsplash.com/photo-1631515243349-e0cb75fb8d3a?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _lasagnaImg =
    "https://images.unsplash.com/photo-1574894709920-11b28e7367e3?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _falafelImg =
    "https://thumb.wikimedia.org/wikipedia/commons/thumb/5/57/Falafels_2.jpg/960px-Falafels_2.jpg";
const String _saladBowlImg =
    "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _noodleSoupImg =
    "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _meatballsImg =
    "https://images.unsplash.com/photo-1529042410759-befb1204b468?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _bakedPotatoImg =
    "https://images.unsplash.com/photo-1585032226651-759b368d7246?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80";
const String _fishChipsImg =
    "https://thumb.wikimedia.org/wikipedia/commons/thumb/f/ff/Fish_and_chips_blackpool.jpg/960px-Fish_and_chips_blackpool.jpg";
const String _hotDogImg =
...
final List<Recipe> mockRecipes = [
  ...
  Recipe(
    ...
    reviews: 320,
    description:
        "A juicy, perfectly grilled beef patty topped with melted cheese, fresh lettuce, and tomatoes in a toasted brioche bun.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 310,
    description:
        "Authentic Italian pasta tossed in a creamy sauce made of eggs, Pecorino Romano cheese, pancetta, and freshly cracked black pepper.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 210,
    description:
        "Crispy artisan sourdough toast topped with creamy smashed avocado, a perfectly poached egg, and a sprinkle of chili flakes.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 450,
    description:
        "Perfectly grilled salmon fillets with a crispy skin and a tender, flaky inside, seasoned with fresh lemon and herbs.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 250,
    description:
        "Warm soft tortillas filled with spicy ground beef, fresh homemade salsa, shredded cheese, and crisp lettuce.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 330,
    description:
        "A comforting, authentic bowl of Japanese ramen featuring a deep soy sauce-based broth, tender pork chashu, and a soft-boiled egg.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 400,
    description:
        "Soft, thick, and incredibly fluffy buttermilk pancakes stacked high and served hot with melting butter and rich maple syrup.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 210,
    description:
        "A rich, vibrant, and aromatic chicken curry simmered in a spiced tomato and creamy coconut milk sauce, served with jasmine rice.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 450,
    description:
        "Fudgy, gooey, and intensely chocolatey brownies with a perfect crinkly top and chunks of melted dark chocolate inside.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 280,
    description:
        "The ultimate cozy comfort food, featuring tender elbow macaroni completely smothered in a rich, creamy, and gooey cheddar cheese sauce.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 180,
    description:
        "A classic triple-decker club sandwich layered with roasted turkey, crispy bacon, fresh lettuce, and ripe tomatoes.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 520,
    description:
        "A beautifully roasted whole chicken seasoned with fresh rosemary, thyme, and garlic, offering crispy skin and tender meat.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 290,
    description:
        "A creamy, comforting Italian risotto made with Arborio rice, sautéed mushrooms, white wine, and parmesan cheese.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 380,
    description:
        "A vibrant Spanish dish combining saffron-infused rice, shrimp, mussels, and chorizo for a flavorful feast.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 150,
    description:
        "Toasted slices of rustic bread rubbed with garlic and topped with a fresh mix of diced tomatoes, basil, and balsamic glaze.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 210,
    description:
        "Soft, tender muffins bursting with juicy blueberries, topped with a sweet, crumbly streusel topping.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 340,
    description:
        "Classic French pastry that is beautifully flaky on the outside and wonderfully soft and buttery on the inside.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 280,
    description:
        "Soft, pillowy yeast donuts deep-fried to perfection and coated in a sweet, translucent vanilla glaze.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 190,
    description:
        "A rich, creamy, and smooth homemade vanilla ice cream made with real vanilla beans and a rich egg custard base.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 410,
    description:
        "Fall-off-the-bone tender pork ribs slow-cooked and slathered in a sticky, sweet, and smoky barbecue sauce.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 480,
    description:
        "A highly aromatic and flavorful Indian dish consisting of spiced basmati rice layered with marinated chicken and caramelized onions.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 370,
    description:
        "Layers of tender pasta, rich meat sauce, creamy ricotta, and melted mozzarella cheese baked to bubbly perfection.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 220,
    description:
        "Crispy, golden-brown chickpea falafels wrapped in a warm pita with fresh veggies and a generous drizzle of tahini sauce.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 160,
    description:
        "A nutrient-packed bowl featuring fluffy quinoa, roasted sweet potatoes, fresh kale, avocado, and a lemon-tahini dressing.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 310,
    description:
        "A soothing, classic soup loaded with tender chicken, egg noodles, carrots, and celery in a savory, golden broth.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 270,
    description:
        "Juicy, flavorful meatballs made with a blend of ground beef and pork, simmered in a rich marinara sauce.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 190,
    description:
        "A large, fluffy baked potato stuffed to the brim with melted cheddar, crispy bacon bits, sour cream, and chives.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 300,
    description:
        "A British classic featuring flaky white fish encased in a light, crispy beer batter, served with thick-cut golden fries.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 140,
    description:
        "A premium all-beef frankfurter grilled to perfection, nestled in a toasted bun and topped with caramelized onions and spicy mustard.",
    instructions: [
  ...
  Recipe(
    ...
    reviews: 260,
    description:
        "A hearty and satisfying start to the day: a warm flour tortilla packed with scrambled eggs, spicy chorizo, melted cheese, and crispy hash browns.",
    instructions: [
