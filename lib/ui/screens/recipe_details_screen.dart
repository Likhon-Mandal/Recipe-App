...
class _RecipeDetailsScreenState extends State<RecipeDetailsScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        final baseAmounts = widget.recipe.ingredients
            .map((ing) => ing.baseAmount)
            .toList();
  ...
  Widget _stagger(int i, Widget child) => FadeTransition(
    ...
    child: SlideTransition(position: _itemSlideAnimations[i], child: child),
  );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _stagger(
                          ...
                          Consumer<QuantityProvider>(
                            builder: (context, quantityProvider, _) {
                              final servings = quantityProvider.currentNumber;
                              return ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  final amount =
                                      (ingredient.baseAmount * servings)
                                          .toStringAsFixed(1);
      ...
      floatingActionButton: Padding(
        ...
        child: Row(
          children: [
            Expanded(child: _StartCookingButton(recipe: recipe)),
            const SizedBox(width: 12),
