...
<p align="center">
  A stunning, maroon-themed modern recipe application built with Flutter, Provider, and Firebase. 
...
<div align="center">
  ...
  [![GitHub release (latest by date)](https://img.shields.io/github/v/release/Likhon-Mandal/Recipe-App?style=flat-square)](https://github.com/Likhon-Mandal/Recipe-App/releases)
  [![GitHub all releases](https://img.shields.io/github/downloads/Likhon-Mandal/Recipe-App/total?style=flat-square)](https://github.com/Likhon-Mandal/Recipe-App/releases)
  [![Visitors](https://visitor-badge.laobi.icu/badge?page_id=Likhon-Mandal.Recipe-App)](https://github.com/Likhon-Mandal/Recipe-App)
...
- 🎨 **Premium Maroon UI**: A modern, aesthetically rich design featuring smooth micro-animations, glassmorphism, and deep maroon accents (#800000).
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/Likhon-Mandal/Recipe-App.git
   cd Recipe-App
   ```
...
You can download the latest optimized, production-ready APK directly from our [Releases page](https://github.com/Likhon-Mandal/Recipe-App/releases).
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/Likhon-Mandal/Recipe-App/issues).
...
## 👤 Author
- **Name**: Likhon Mandal
- **Email**: [likhon.cse9.bu@gmail.com](mailto:likhon.cse9.bu@gmail.com)
- **GitHub**: [@Likhon-Mandal](https://github.com/Likhon-Mandal)
